...
describe('wiggleSort', function () {
    ...
    it('should return push MinMax pairs with eq neibers smart swap', function () {
        ...
        wiggleSort(nums);
        assert.deepEqual([5, 6, 5, 6, 5, 6, 4, 5], nums);
    });
})